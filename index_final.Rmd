...
rules <- apriori(tr, parameter = list(sup = 0.0035, conf = 0.8))
...
tickets2 <- read_csv("output/tickets2.csv") %>% 
  mutate(foco = as_factor(foco))
...
predicted <- read_csv("output/predicted.csv")
...
include_graphics("img/conclusao.png")
