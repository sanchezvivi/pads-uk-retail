...
direita <- rules.sub@rhs@itemInfo
esquerda <- rules.sub@lhs@itemInfo
...
rt_days() %>% 
  ggplot(aes(y = get(selected_col_2()), x = full_hour, fill = holiday)) +
