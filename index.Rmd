...
if(!require(dplyr)){install.packages("dplyr", "v0.7.8"); library(dplyr)}
...
pca_prep <- rt_uk %>% 
   ...
   pivot_wider(names_from = description,
              ...
              values_fill = list(total_quantity = 0)) %>% #janitor::clean_names() %>% glimpse()
...
cols_prod <- tibble(col = c("avg_price","tkts" ,"clients","quantity", "total_investment", "total_revenue"),
